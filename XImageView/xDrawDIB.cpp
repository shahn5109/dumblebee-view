	...
	case 8:
		...
		for ( i=nDstY+nDstOffsetY ; i < nDstOffH-nDstOffsetH ; i++ )
		{
			...
			{ 
				...
				if ( nTH >= nImgHeight || nTW >= nImgWidth || nTW < 0 || nTH < 0 ) continue;
